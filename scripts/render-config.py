...
def main() -> int:
    ...
    helper_backend_enabled = parse_bool(optional_env("HELPER_BACKEND_ENABLED"), default=True)
    helper_backend_server_type = (
        require_env("HELPER_BACKEND_SERVER_TYPE")
        if helper_backend_enabled
        else optional_env("HELPER_BACKEND_SERVER_TYPE") or bastion_server_type
    )
    ...
    helper_backend_dns_requested = helper_backend_enabled and bool(
        optional_env("HELPER_BACKEND_FQDN") or optional_env("HELPER_BACKEND_URL")
    )
    ...
    helper_backend_api_token = ""
    helper_backend_url = ""
    helper_backend_fqdn = ""
    helper_backend_wg_private_key = ""
    helper_backend_wg_public_key = ""
    helper_backend_wg_preshared_key = ""
    helper_backend_wg_ip = ""
    helper_backend_ssh_user = ""
    helper_backend_ssh_private_key = ""
    ...
    config["helper_backend_enabled"] = helper_backend_enabled
