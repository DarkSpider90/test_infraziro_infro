...
const runtimeConfig = {
  ...
  network: {
    ...
    grafanaPublicUrl: optionalString(networkSource.grafanaPublicUrl),
    lokiUrl: requireString(networkSource.lokiUrl, "internal.lokiUrl"),
    lokiPublicUrl: optionalString(networkSource.lokiPublicUrl),
    infisicalUrl: requireString(networkSource.infisicalUrl, "internal.infisicalUrl"),
    infisicalPublicUrl: optionalString(networkSource.infisicalPublicUrl),
